...
/**
 * The model for the Wizard component, which tracks the text, icons, and enabled state of each of
 * the buttons, as well as the current panel that is displayed. Note that the model, in its current
 * form, is not intended to be subclassed.
 */
...
public class WizardModel {
  ...
  boolean setCurrentPanel(Object id) {
    ...
    if (oldPanel != currentPanel) {
      firePropertyChange(WizardModel.CURRENT_PANEL_DESCRIPTOR_PROPERTY, oldPanel, currentPanel);
    }
  ...
  Object getBackButtonText() {
    return buttonTextHashmap.get(WizardModel.BACK_BUTTON_TEXT_PROPERTY);
  }
  ...
  void setBackButtonText(Object newText) {
    ...
    if (!newText.equals(oldText)) {
      buttonTextHashmap.put(WizardModel.BACK_BUTTON_TEXT_PROPERTY, newText);
      firePropertyChange(WizardModel.BACK_BUTTON_TEXT_PROPERTY, oldText, newText);
    }
  }

  Object getNextFinishButtonText() {
    return buttonTextHashmap.get(WizardModel.NEXT_FINISH_BUTTON_TEXT_PROPERTY);
  }
  ...
  void setNextFinishButtonText(Object newText) {
    ...
    if (!newText.equals(oldText)) {
      buttonTextHashmap.put(WizardModel.NEXT_FINISH_BUTTON_TEXT_PROPERTY, newText);
      firePropertyChange(WizardModel.NEXT_FINISH_BUTTON_TEXT_PROPERTY, oldText, newText);
    }
  }

  Object getCancelButtonText() {
    return buttonTextHashmap.get(WizardModel.CANCEL_BUTTON_TEXT_PROPERTY);
  }
  ...
  void setCancelButtonText(Object newText) {
    ...
    if (!newText.equals(oldText)) {
      buttonTextHashmap.put(WizardModel.CANCEL_BUTTON_TEXT_PROPERTY, newText);
      firePropertyChange(WizardModel.CANCEL_BUTTON_TEXT_PROPERTY, oldText, newText);
    }
  }

  Icon getBackButtonIcon() {
    return buttonIconHashmap.get(WizardModel.BACK_BUTTON_ICON_PROPERTY);
  }
  ...
  void setBackButtonIcon(Icon newIcon) {
    ...
    if (!newIcon.equals(oldIcon)) {
      buttonIconHashmap.put(WizardModel.BACK_BUTTON_ICON_PROPERTY, newIcon);
      firePropertyChange(WizardModel.BACK_BUTTON_ICON_PROPERTY, oldIcon, newIcon);
    }
  }

  Icon getNextFinishButtonIcon() {
    return buttonIconHashmap.get(WizardModel.NEXT_FINISH_BUTTON_ICON_PROPERTY);
  }
  ...
  public void setNextFinishButtonIcon(Icon newIcon) {
    ...
    if (!newIcon.equals(oldIcon)) {
      buttonIconHashmap.put(WizardModel.NEXT_FINISH_BUTTON_ICON_PROPERTY, newIcon);
      firePropertyChange(WizardModel.NEXT_FINISH_BUTTON_ICON_PROPERTY, oldIcon, newIcon);
    }
  }

  Icon getCancelButtonIcon() {
    return buttonIconHashmap.get(WizardModel.CANCEL_BUTTON_ICON_PROPERTY);
  }
  ...
  void setCancelButtonIcon(Icon newIcon) {
    ...
    if (!newIcon.equals(oldIcon)) {
      buttonIconHashmap.put(WizardModel.CANCEL_BUTTON_ICON_PROPERTY, newIcon);
      firePropertyChange(WizardModel.CANCEL_BUTTON_ICON_PROPERTY, oldIcon, newIcon);
    }
  }

  Boolean getBackButtonEnabled() {
    return buttonEnabledHashmap.get(WizardModel.BACK_BUTTON_ENABLED_PROPERTY);
  }
  ...
  void setBackButtonEnabled(Boolean newValue) {
    ...
    if (newValue != oldValue) {
      buttonEnabledHashmap.put(WizardModel.BACK_BUTTON_ENABLED_PROPERTY, newValue);
      firePropertyChange(WizardModel.BACK_BUTTON_ENABLED_PROPERTY, oldValue, newValue);
    }
  }

  Boolean getNextFinishButtonEnabled() {
    return buttonEnabledHashmap.get(WizardModel.NEXT_FINISH_BUTTON_ENABLED_PROPERTY);
  }
  ...
  void setNextFinishButtonEnabled(Boolean newValue) {
    ...
    if (newValue != oldValue) {
      buttonEnabledHashmap.put(WizardModel.NEXT_FINISH_BUTTON_ENABLED_PROPERTY, newValue);
      firePropertyChange(WizardModel.NEXT_FINISH_BUTTON_ENABLED_PROPERTY, oldValue, newValue);
    }
  }

  Boolean getCancelButtonEnabled() {
    return buttonEnabledHashmap.get(WizardModel.CANCEL_BUTTON_ENABLED_PROPERTY);
  }
  ...
  void setCancelButtonEnabled(Boolean newValue) {
    ...
    if (newValue != oldValue) {
      buttonEnabledHashmap.put(WizardModel.CANCEL_BUTTON_ENABLED_PROPERTY, newValue);
      firePropertyChange(WizardModel.CANCEL_BUTTON_ENABLED_PROPERTY, oldValue, newValue);
    }
  }
