...
public class LicenseAgreementPanel extends JPanel {
  ...
  private void initComponents() {
    ...
    // ======== panel1 ========
    {
      ...
      label2.setIcon(new ImageIcon(getClass().getResource(
          "/com/swingsane/installer/images/swingsane_package_small.png"))); //$NON-NLS-1$
  ...
  private void loadLicenseAgreementString() {
	  InputStream in = getClass().getResourceAsStream("/com/swingsane/installer/LICENSE");
	  try {
		  textArea1.read(new InputStreamReader(in), null);
		  in.close();
	  } catch (IOException ex) {
		  System.out.println("Could not find license agreement.");
		  System.exit(0);
	  }
  }
