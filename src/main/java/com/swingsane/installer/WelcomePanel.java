...
public class WelcomePanel extends JPanel {
  ...
  private void initComponents() {
    ...
    label1.setIcon(new ImageIcon(getClass().getResource(
        "/com/swingsane/installer/images/swingsane_package.png"))); //$NON-NLS-1$
    ...
    // ======== panel1 ========
    {
      ...
      textPane1
          .setText("This will install SwingSane on your computer.  It is recommended that you close all other applications before continuing.  Click Next to continue, or Cancel to exit Setup."); //$NON-NLS-1$
