...
public class SetupOptionsPanel extends JPanel {
  ...
  public void setDefaultInstallationFolder() {
    if (Main.WINDOWS) {
      setDestinationFolder("C:\\Program Files\\SwingSane");
    } else if (Main.MAC_OS_X) {
      setDestinationFolder("/Applications/SwingSane");
    } else {
      // linux or unix?
      setDestinationFolder(System.getProperty("user.home") + "/SwingSane");
    }
  }
  ...
  private void initComponents() {
    ...
    // ======== panel1 ========
    {
      ...
      label2.setIcon(new ImageIcon(getClass().getResource(
          "/com/swingsane/installer/images/swingsane_package_small.png")));
