...
import com.swingsane.installer.LicenseAgreementPanelDescriptor;

/**
 * This class is responsible for reacting to events generated by pushing any of the three buttons,
 * 'Next', 'Previous', and 'Cancel.' Based on what button is pressed, the controller will update the
...
public class WizardController implements ActionListener {
  ...
  /**
   * This constructor accepts a reference to the Wizard component that created it, which it uses to
   * update the button components and access the WizardModel.
   * 
   * @param w
   *          A callback to the Wizard component that created this controller.
   */
  ...
  /**
   * Calling method for the action listener interface. This class listens for actions performed by
   * the buttons in the Wizard class, and calls methods below to determine the correct course of
   * action.
   * 
   * @param evt
  ...
  private void nextButtonPressed() {
    ...
    if (nextPanelDescriptor == LicenseAgreementPanelDescriptor.IDENTIFIER) {
      wizard.getMain().checkForPrivilegedExecution();
    }
